...
| Archivo | Qué responde |
|---|---|
| [§4.1–4.5, 4.30–4.31 Tareas y tablero](specs/tareas-y-tablero.md) | El CRUD de tareas, la degradación diaria al backlog, la vista semana, Today, el modal de detalle, el backlog, las prioridades y el modal de crear. |
